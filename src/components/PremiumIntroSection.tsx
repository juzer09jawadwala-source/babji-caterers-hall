...
export function PremiumIntroSection() {
  ...
  return (
    <section ref={containerRef} className="relative z-20 w-full bg-white pt-24 md:pt-32 pb-24 md:pb-40 px-6 md:px-12 lg:px-24 overflow-visible border-b border-black/5">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-[55%] w-[300px] md:w-[450px] h-[300px] md:h-[450px] pointer-events-none z-30">
      ...
      <div className="absolute bottom-0 right-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] translate-y-[20%] translate-x-[15%] pointer-events-none z-20 opacity-90 drop-shadow-lg">
