  ...
  return (
    <section className="py-24 md:py-32 px-6 md:px-12 max-w-[1400px] mx-auto relative overflow-hidden bg-transparent">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12">
        <div className="lg:col-span-5 relative flex flex-col justify-between min-h-0 lg:min-h-[700px]">
          <SectionReveal delay={0.1}>
            <div className="flex flex-col gap-6 pl-0 sm:pl-4 md:pl-8">
              <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-espresso">Our Menu</h2>
              <ShelfPlate img="/images/chicken.png" className="ml-0 md:-ml-12" />
            </div>
          </SectionReveal>
          ...
          <SectionReveal delay={0.5}>
            <div className="max-w-sm mt-auto pb-6 md:pb-12 pt-8 sm:pt-16 lg:pt-0">
              <h2 className="font-serif text-3xl sm:text-4xl text-espresso mb-3 sm:mb-4">Trestiraming</h2>
        ...
        <div className="lg:col-span-7 relative flex flex-col justify-between">
          <SectionReveal delay={0.2}>
            <div className="relative w-full aspect-[4/3] md:aspect-[16/10] rounded-[24px] sm:rounded-[32px] md:rounded-[40px] shadow-2xl group border border-espresso/5 bg-espresso/5 mt-8 md:mt-0">
              <Image 
                ...
                quality={85}
                className="object-cover transition-transform duration-2000 group-hover:scale-105 rounded-[24px] sm:rounded-[32px] md:rounded-[40px]" 
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-80 transition-opacity duration-500 group-hover:opacity-90 rounded-[24px] sm:rounded-[32px] md:rounded-[40px]" />
              
              <motion.div 
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="absolute top-1/2 left-4 sm:-left-6 md:-left-10 transform -translate-y-1/2 w-12 h-12 sm:w-14 sm:h-14 md:w-20 md:h-20 bg-espresso rounded-full flex items-center justify-center cursor-pointer shadow-xl border-2 sm:border-4 border-ivory z-30"
              >
                <div className="w-0 h-0 border-t-[5px] sm:border-t-[6px] md:border-t-[8px] border-t-transparent border-l-[8px] sm:border-l-[10px] md:border-l-[14px] border-l-ivory border-b-[5px] sm:border-b-[6px] md:border-b-[8px] border-b-transparent ml-1"></div>
              </motion.div>

              <div className="absolute bottom-6 left-6 right-6 sm:bottom-8 sm:left-8 md:bottom-12 md:left-12 max-w-md pr-4 sm:pr-8 z-20">
                <h2 className="font-serif text-3xl sm:text-4xl md:text-6xl text-ivory mb-2 sm:mb-4 tracking-wide drop-shadow-md">About Us</h2>
                <p className="font-sans text-ivory/80 text-xs sm:text-sm md:text-base leading-relaxed drop-shadow-sm">
