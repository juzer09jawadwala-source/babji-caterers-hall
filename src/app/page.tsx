    ...
    <div className="bg-ivory selection:bg-gold-light/40 selection:text-espresso">
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto w-full">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-end mb-16 md:mb-24">
            <div className="md:col-span-7">
              ...
              <SectionReveal variant="heading" delay={0.2}>
          ...
          <RevealGroup className="grid grid-cols-1 md:grid-cols-3 gap-6" stagger={0.12} delay={0.4}>
            {[
              {
              ...
              <RevealItem key={i} variant="card">
                <div className="bg-espresso-soft/80 backdrop-blur-md rounded-[16px] p-8 shadow-soft border border-ivory/10 transition-transform duration-500 hover:-translate-y-1">
      ...
      <section className="bg-sand py-24 md:py-32 px-6 md:px-12 -mt-[40px] pt-[80px] relative z-0">
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <SectionReveal variant="image" delay={0.2} className="flex justify-center md:justify-end">
      ...
      <section className="bg-ivory py-24 md:py-32 px-6 md:px-12">
        <div className="max-w-[1240px] mx-auto flex flex-col items-center text-center mb-16">
          ...
          <SectionReveal variant="heading" delay={0.15}>
        ...
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <SectionReveal variant="image" delay={0.25}>
            ...
            return (
              <div key={dish.id} className={`grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center ${isEven ? 'md:flex-row-reverse' : ''}`}>
                <div className={`${isEven ? 'md:order-2' : ''}`}>
                  <SectionReveal variant="image" delay={0.1}>
                    <div className="relative aspect-square md:aspect-[4/5] rounded-[24px] overflow-hidden shadow-2xl">
      ...
      <section className="bg-sand py-24 md:py-32 px-6 md:px-12 overflow-hidden">
        <div className="max-w-[1240px] mx-auto">
          ...
          <div className="flex justify-center items-center gap-2 sm:gap-4 md:gap-6 mb-16 md:mb-24 h-[300px] md:h-[450px]">
            {/* Col 1 */}
            <SectionReveal variant="image" delay={0.05} className="hidden lg:flex flex-col gap-4 translate-y-8">
            ...
            {/* Col 2 */}
            <SectionReveal variant="image" delay={0.12} className="hidden md:flex flex-col gap-4 -translate-y-4">
            ...
            {/* Col 3 */}
            <SectionReveal variant="image" delay={0.2} className="hidden sm:block">
            ...
            <SectionReveal variant="image" delay={0.28} className="z-10">
            ...
            {/* Col 5 */}
            <SectionReveal variant="image" delay={0.36} className="hidden sm:flex flex-col gap-4 -translate-y-8">
            ...
            {/* Col 6 */}
            <SectionReveal variant="image" delay={0.42} className="hidden md:block">
            ...
            {/* Col 7 */}
            <SectionReveal variant="image" delay={0.48} className="hidden lg:flex flex-col gap-4 -translate-y-6">
              <div className="relative w-[70px] h-[100px] rounded-[16px] overflow-hidden shadow-md">
                <Image src="/images/fish.jpg" alt="Food" fill className="object-cover" quality={100} unoptimized />
              </div>
          ...
          <div className="flex flex-col items-center text-center mb-16 md:mb-24">
            <SectionReveal variant="heading" delay={0.15} className="flex flex-col items-center">
          ...
          <RevealGroup className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16" stagger={0.12} delay={0.2}>
            {[
              {
      ...
      <section className="bg-espresso py-24 md:py-32 px-6 md:px-12 text-center">
        <div className="max-w-[800px] mx-auto flex flex-col items-center">
          ...
          <SectionReveal variant="scale" delay={0.35}>
